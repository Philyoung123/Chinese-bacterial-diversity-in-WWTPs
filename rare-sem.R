...
#读取数据
dat<-read.csv('rareenv.csv',row.names=1)
dat=na.omit(dat[,])
...
dat_blocks <- list(
  ...
  operating_parameter = c('MLSS', 'SRT', 'HRT','DO','Cond','pH'),
  rare =  c('Community1', 'Community2', 'Community3','Community4','Community5','Community6','Community7','Community8','Community9','Community10','Community11','Community12','Community13','Community14','Community15','Community16','Community17','Community18','Community19','Community20',
...
rare<- c(1,1,1,0)
dat_path <- rbind(space,influent_quality,operating_parameter,rare)
